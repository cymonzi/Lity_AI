# Enhanced Lity AI Training in Google Colab
# Updated version with improved dataset and training configuration

# 1. Install required libraries (enhanced version)
# NOTE: These are Colab magic commands - they will work in Google Colab but not in local Python
# pip install transformers datasets accelerate peft bitsandbytes
# pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu118

import torch
import json
# NOTE: The following imports will work in Google Colab after installing the packages above
# They may show as missing in local IDE but are available in Colab environment
from datasets import Dataset  # Available after: pip install datasets
...
from peft import LoraConfig, get_peft_model, prepare_model_for_kbit_training  # Available after: pip install peft
import warnings
...
# NOTE: This is a Colab shell command - use in Colab environment
...
# Download everything - NOTE: This works only in Google Colab
...
print("NOTE: To download files in Colab, uncomment the lines above")
